        ...
        <header className="admin-header">
            ...
            <div className="header-left">
                ...
                <div className="breadcrumbs desktop-only">
                    ...
                    {breadcrumbs.length > 0 && <ChevronRight size={14} className="separator" />}
                    ...
                    {breadcrumbs.map((item, index) => (
                        <div key={item.href} className="breadcrumb-item">
                            ...
                            {index === breadcrumbs.length - 1 ? (
                                ...
                                <Link href={item.href} className="link">{item.name}</Link>
                            )}
                        </div>
                    ))}
                </div>
            ...
            <div className="header-right">
                ...
                <button className="icon-btn mobile-only" title="搜索">
                    <Search size={18} />
                </button>

                <button className={`icon-btn ${isRefreshing ? 'spin' : ''}`} title="刷新" onClick={handleRefresh}>
                    <RefreshCw size={18} />
                </button>

                <button className="icon-btn desktop-only" title="全屏" onClick={toggleFullscreen}>
