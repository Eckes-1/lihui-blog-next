...
export default function PostCard({ title, excerpt, date, link }: PostCardProps) {
    return (
        <div className="post-card-wrap">
            <Link className="post-card post" href={link}>
                <article className="md-text">
                    ...
                    <div className="meta cap">
                        <span className="cap" id="post-meta">
                            <svg style={{ marginBottom: "2px" }} xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
                                ...
                                <path fill="currentColor" d="M22 14v-2c0-.839-.004-2.335-.017-3H2.01c-.013.665-.01 2.161-.01 3v2c0 3.771 0 5.657 1.172 6.828C4.343 22 6.228 22 10 22h4c3.77 0 5.656 0 6.828-1.172C22 19.658 22 17.772 22 14" opacity=".5" />
