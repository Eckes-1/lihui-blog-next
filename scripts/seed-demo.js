...
async function seedDemo() {
    console.log("🚀 Seeding demo post...");

    try {
        const slug = "exploring-stellar-theme";
        const title = "深入探索 Stellar 主题：功能与美学的完美融合";
        const excerpt = "本文旨在展示 Stellar 主题在 Next.js 复刻版中的完美表现。我们将测试各种 Markdown 元素，包括长文本、代码块、列表以及图片。";
        const content = `
...
`;
        ...
        console.log("✅ Demo post inserted successfully!");

    } catch (err) {
        console.error("❌ Error seeding demo post:", err);
    }
}
